...
link_to_product = input("Enter link to product: ")
...
options.binary_location = firefox_exe_path  # Pfad zum Tor-Browser
...
text_part = MIMEText("Dies ist eine Textversion der E-Mail.", "plain") # not needed but wouldnt delete it
...
print("✅ E-Mail sent successfully, script finished")
